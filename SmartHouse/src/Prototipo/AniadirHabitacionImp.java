...
public class AniadirHabitacionImp extends AniadirHabitacion{
	...
	public void initGUI() {
		...
		textField.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(FocusEvent arg0) {
				if (textField.getText().equals("IDCasa")) {
					textField.setText("");
				}
			}
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				THabitacion thab = new THabitacion(txtTipo.getText(),IdCasaparse,txtNombre.getText());
