...
public class ListarUsuarioImp extends ListarUsuario{
	...
	public void initGUI() {
		...
		String[] names = {"Id", "Id Casa", "correo", "tipo", "contrase�a", "edad", "nombre", "apellidos"};
		table = new JTable();
		...
		modify_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (!table.getSelectionModel().isSelectionEmpty()) {
					...
					panel.add(new JLabel("Contrase�a de usuario: "));
					...
					if (result == JOptionPane.OK_OPTION) {
						...
						if (contr.equals(""))
							JOptionPane.showMessageDialog(null, "La contrase�a no puede estar en blanco",
