...
public class BorrarDispositivoImp extends BorrarDispositivo {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BorrarDispositivo frame = new BorrarDispositivo();
	...
	public BorrarDispositivoImp() {
		...
		JButton btnGuardar = new JButton("Borrar");
