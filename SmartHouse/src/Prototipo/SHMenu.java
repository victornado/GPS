...
public class SHMenu extends JFrame {
	...
	private AniadirDispositivo addDisp;
	private BorrarDispositivo borrarDisp;
	...
	public SHMenu() {
		...
		actv=false;
		this.modificar = new ModificarUsuario();
		this.addDisp = new AniadirDispositivo();
		this.borrarDisp = new BorrarDispositivo();
		initGUI();
	}
	...
	public void initGUI() {
		...
		label_2.setIcon(new ImageIcon(SHMenu.class.getResource("/img/estrella.png")));
		...
		label_3.setIcon(new ImageIcon(SHMenu.class.getResource("/img/c-.png")));
		label_3.setBounds(155, 261, 30, 25);
		panel_1.add(label_3);
		
		JButton button = new JButton("");
		button.setIcon(new ImageIcon(SHMenu.class.getResource("/img/c-.png")));
		button.setBounds(195, 263, 25, 25);
		panel_1.add(button);
		
		JButton button_1 = new JButton("");
		button_1.setIcon(new ImageIcon(SHMenu.class.getResource("/img/c--.png")));
		button_1.setBounds(225, 263, 25, 25);
		panel_1.add(button_1);
		
		JButton button_2 = new JButton("");
		button_2.setIcon(new ImageIcon(SHMenu.class.getResource("/img/play.png")));
		button_2.setBounds(255, 263, 25, 25);
		panel_1.add(button_2);
		
		JButton button_3 = new JButton("");
		button_3.setIcon(new ImageIcon(SHMenu.class.getResource("/img/--D.png")));
		button_3.setBounds(285, 263, 25, 25);
		panel_1.add(button_3);
		
		JButton button_4 = new JButton("");
		button_4.setIcon(new ImageIcon(SHMenu.class.getResource("/img/-D.png")));
		button_4.setBounds(316, 263, 25, 25);
		panel_1.add(button_4);
		
		JButton button_5 = new JButton("");
		button_5.setIcon(new ImageIcon(SHMenu.class.getResource("/img/lupa.png")));
		...
		label_4.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Netflix 30x30.png.png")));
		label_4.setBounds(78, 258, 30, 30);
		panel_1.add(label_4);
		
		JToggleButton toggleButton_1 = new JToggleButton("");
		toggleButton_1.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
		...
		toggleButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				if(!actv) {
					toggleButton_1.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
		...
		toggleButton_2.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
		...
		toggleButton_2.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				if(!actv) {
					toggleButton_2.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
		...
		toggleButton_3.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
		panel_1.add(toggleButton_3);
		toggleButton_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				if(!actv) {
					toggleButton_3.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
		...
		toggleButton_4.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
		panel_1.add(toggleButton_4);
		toggleButton_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				if(!actv) {
					toggleButton_4.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
		...
		toggleButton_5.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
		panel_1.add(toggleButton_5);
		toggleButton_5.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				if(!actv) {
					toggleButton_5.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
		...
		toggleButton_6.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
		panel_1.add(toggleButton_6);
		toggleButton_6.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				if(!actv) {
					toggleButton_6.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
		...
		button_6.setIcon(new ImageIcon(SHMenu.class.getResource("/img/papelera.png")));
		...
		button_7.setIcon(new ImageIcon(SHMenu.class.getResource("/img/lupa.png")));
		...
		button_8.setIcon(new ImageIcon(SHMenu.class.getResource("/img/+.png")));
		...
		label.setIcon(new ImageIcon(SHMenu.class.getResource("/img/colores.png")));
		panel.add(label);
		...
		toggleButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if(!actv) {
				toggleButton.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Switch ON.png")));
				actv=true;
				
				}
				else {
					toggleButton.setIcon(new ImageIcon(SHMenu.class.getResource("/img/Siwtch OFF.png")));
					actv=false;
				}				
			}
		});
